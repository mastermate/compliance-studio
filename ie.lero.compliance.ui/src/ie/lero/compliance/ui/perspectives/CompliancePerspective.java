package ie.lero.compliance.ui.perspectives;
...
import ie.lero.compliance.ui.views.ComplianceExplorerView;
import ie.lero.compliance.ui.views.EnvironmentView;
import ie.lero.compliance.ui.views.ExplanationsView;
 ...
 *  to change. 
 */
public class CompliancePerspective implements IPerspectiveFactory {

	private IPageLayout factory;

	public CompliancePerspective() {
		super();
	}
	...
	private void addViews() {
		...
		bottom.addView(ComplianceExplorerView.ID);
		bottom.addView(EnvironmentView.ID);
		bottom.addView(ExplanationsView.ID);
